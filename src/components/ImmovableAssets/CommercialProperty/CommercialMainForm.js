...
const CommercialMainForm = () => {
  ...
  const confirmDelete = async (id) => {
    const response = await axios.delete(
      `/api/commercial-properties/${lifeInsuranceDeleteId}`,
      {
        headers: {
          Authorization: `Bearer ${user.data.token}`,
        },
    ...
    <div className="w-[100%] bg-white">
      <div className="flex flex-col w-[100%] ">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">Commercial Property</h1>
          <Button onMouseDown={() => navigate("/commercialproperty/add")}>
            ...
            Benifyciary.map((data) => (
              ...
              >
                <div className="flex flex-col  ml-8">
                  <h1 className="font-bold">{data.houseNumber}</h1>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() => {
                          ...
                          navigate("/commercialproperty/edit");
                        }}
                      >
                        Edit
                      </DropdownMenuItem>
...
export default CommercialMainForm;
