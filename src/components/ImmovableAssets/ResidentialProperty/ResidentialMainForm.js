...
const ResidentialMainForm = () => {
  ...
  const confirmDelete = async (id) => {
    const response = await axios.delete(
      `/api/residential-properties/${lifeInsuranceDeleteId}`,
      {
        headers: {
          Authorization: `Bearer ${user.data.token}`,
        },
    ...
    <div className="w-[100%] bg-white">
      <div className="flex flex-col w-[100%] ">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">Residential Property</h1>
          <Button onMouseDown={() => navigate("/residentialproperty/add")}>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() => {
                          ...
                          navigate("/residentialproperty/edit");
                        }}
                      >
                        Edit
                      </DropdownMenuItem>
