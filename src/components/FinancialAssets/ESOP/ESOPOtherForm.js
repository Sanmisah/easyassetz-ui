...
const schema = z.object({
  ...
  units_granted: z.string().optional(),
  esops_vested: z
    .string()
      ...
      <Card className="w-full">
        ...
        <CardContent className="grid gap-6">
          ...
          >
            ...
            <div className="space-y-2">
              <Label htmlFor="units_granted">Units Granted</Label>
              <Controller
                name="units_granted"
                control={control}
                render={({ field }) => (
                  <Input
                    ...
                    value={field.value}
                    onChange={(e) => field.onChange(e.target.value)}
                    className={errors.units_granted ? "border-red-500" : ""}
                  />
                )}
              />

              {errors.units_granted && (
                <span className="text-red-500">
                  {errors.units_granted.message}
                </span>
              )}
            </div>
            <div className="space-y-2">
              <Label htmlFor="esops_vested">ESOPS Vested</Label>
              <Controller
                name="esops_vested"
                control={control}
                render={({ field }) => (
                  <Input
                    ...
                    value={field.value}
                    onChange={(e) => field.onChange(e.target.value)}
                    className={errors.esops_vested ? "border-red-500" : ""}
                  />
                )}
              />
