...
const PSSEditForm = () => {
  ...
  const getPersonalData = async () => {
    ...
    const response = await axios.get(
      `/api/other-financial-assets/${lifeInsuranceEditId}`,
      {
        headers: {
    ...
    let data = response.data.data.OtherFinancialAsset;
  ...
  //     };
  //     reset(defaultValues);
  //     setShowOtherInsuranceCompany(Benifyciary.branchName === "other");
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Edit the form to update the Other Financial Asset Details.
                </CardDescription>
              </div>
            </div>
          </div>
